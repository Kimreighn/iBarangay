    ...
    async function triggerEmergency(type) {
        ...
        navigator.geolocation.getCurrentPosition(async (pos) => {
            ...
            alert('Emergency alert sent to fellow barangay staff.');
            loadEmergencies();
            loadEmgHistory();
        });
    }
